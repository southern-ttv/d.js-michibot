...
function getFetch() {
    ...
    if (typeof window !== "undefined")
        return window.fetch;
    try {
        for (var _b = __values(["undici", "node-fetch"]), _c = _b.next(); !_c.done; _c = _b.next()) {
            var fetchLib = _c.value;
            try {
                var pkg = require(fetchLib);
...
var Util = (function () {
    ...
    Util.getVideo = function (html) {
        ...
        var raw = {
            primary: (_a = data.find(function (section) { return "videoPrimaryInfoRenderer" in section; })) === null || _a === void 0 ? void 0 : _a.videoPrimaryInfoRenderer,
            secondary: (_b = data.find(function (section) { return "videoSecondaryInfoRenderer" in section; })) === null || _b === void 0 ? void 0 : _b.videoSecondaryInfoRenderer
        };
        var info;
        try {
        ...
        var payload = new Video_1.default({
            ...
            channel: {
                ...
                subscribers: (_d = (_c = info.owner.videoOwnerRenderer.subscriberCountText) === null || _c === void 0 ? void 0 : _c.simpleText) === null || _d === void 0 ? void 0 : _d.replace(" subscribers", "")
            },
    ...
    Util.getInfoLikesCount = function (info) {
        var buttons = info.videoActions.menuRenderer.topLevelButtons;
        var button = buttons.find(function (button) { var _a; return ((_a = button.toggleButtonRenderer) === null || _a === void 0 ? void 0 : _a.defaultIcon.iconType) === "LIKE"; });
        if (!button)
            return 0;
